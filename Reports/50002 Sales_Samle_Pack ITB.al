report 50002 "Sales_Samle_Pack ITB"
{



    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/50002 Sales Samle Pack ITB.rdl';

    CaptionML = DAN = 'PAKKELISTE',
                ENU = 'PACKING LIST';
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(RoundLoop; Integer)
                    {
                        ...
                        trigger OnAfterGetRecord();
                        var
                            itemvar: Record Item;  //HBK / ITB - 070721
                        begin
                            IF Number = 1 THEN
                                SalesLine.FIND('-')
                            ELSE
    ...
    var
        ...
        Text004: TextConst DAN = 'PAKKELISTE %1', DEU = 'PACKLISTE %1', ENU = 'PACKING LIST %1';
